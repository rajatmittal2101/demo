...
public class HealthScriptEnemy : MonoBehaviour
{
    ...
    public bool is_Player, is_Boar, is_Dragon;      //for all dragon,boar,player
    ...
    public void ApplyDamage(float damage)
    {
        ...
        if (is_Boar || is_Dragon)
        {
            ...
            //if you hit the enemy using long range attack the enemy start chasing you
        }
